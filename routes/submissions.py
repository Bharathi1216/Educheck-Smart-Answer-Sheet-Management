...
def submit_answer():
    ...
    try:
        ...
        submission_type = request.form.get('submission_type', 'student_answers')  # 'student_answer' or 'teacher_answer_key'
        ...
        submission_data = {
            ...
            'extracted_text': [result['original_text']] if 'original_text' in locals() and 'result' in locals() else [],
